...
// floating command-palette panel (NIC-75) and at `index.html?surface=settings` into
// the dedicated settings window (backdrop-policy decision, 2026-07-06); everywhere
// else renders the full dashboard. The surfaces are loaded by *dynamic* import so
