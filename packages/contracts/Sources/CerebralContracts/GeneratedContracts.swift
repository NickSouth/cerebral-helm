...
public struct CerebralHelmBridgeBootstrapState: Codable {
    public let activeSurface: String
    ...
    public init(activeSurface: String, commandsToday: Int, mode: Mode, pendingConfirmations: Int, project: String, schemaVersion: String, summary: String, uiState: UIState) {
...
public extension CerebralHelmBridgeBootstrapState {
    ...
    func with(
        ...
        return CerebralHelmBridgeBootstrapState(
            activeSurface: activeSurface ?? self.activeSurface,
...
public struct CerebralHelmAgentSurfaceConfig: Codable {
    ...
    public let status: CerebralHelmAgentSurfaceConfigStatus
    public let summary: String
    ...
    public init(allowedKnowledgeRoots: [String]?, allowedToolIDS: [String]?, extensions: [String: JSONAny]?, id: String, label: String, status: CerebralHelmAgentSurfaceConfigStatus, summary: String) {
...
public extension CerebralHelmAgentSurfaceConfig {
    ...
    func with(
        ...
        id: String? = nil,
        label: String? = nil,
        status: CerebralHelmAgentSurfaceConfigStatus? = nil,
        summary: String? = nil
...
public enum CerebralHelmAgentSurfaceConfigStatus: String, Codable {
...
public struct CerebralHelmModeConfig: Codable {
    ...
    public let quickApps, shortcuts: [String]
    public let widgets: [String]?

    public enum CodingKeys: String, CodingKey {
        case accent
        case agentIDS = "agentIds"
        case extensions, id, label, projectHints, quickApps, shortcuts, widgets
    }

    public init(accent: Accent, agentIDS: [String], extensions: [String: JSONAny]?, id: String, label: String, projectHints: [String]?, quickApps: [String], shortcuts: [String], widgets: [String]?) {
        self.accent = accent
...
public extension CerebralHelmModeConfig {
    ...
    func with(
        ...
        return CerebralHelmModeConfig(
            ...
            agentIDS: agentIDS ?? self.agentIDS,
            extensions: extensions ?? self.extensions,
            id: id ?? self.id,
            label: label ?? self.label,
...
public enum Accent: String, Codable {
    case blue = "blue"
    case coral = "coral"
    case cyan = "cyan"
    case gold = "gold"
...
public extension Availability {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(Availability.self, from: data)
    }
